...
cols = list(pd.read_csv("all_results_nlb.csv", nrows =1))
print (str(cols))
...
df= pd.read_csv("all_results_nlb.csv", sep=",")
...
plt.title("Average time spent by teams in bounds NON Load Balancing")
plt.savefig("fig1_" + foldername+"_Nlb.png")
...
plt.title("Distribution running time per node (s) NON Load Balancing")
plt.savefig("fig2_" + foldername+"_Nlb.png")
plt.show()
...
plt.title("Distribution of tasks per node and team NON Load Balancing")
plt.savefig("fig3_" + foldername+"_Nlb.png")
...
plt.ylabel('Number of tasks', fontsize=16)
plt.title("Distribution of tasks per node and team NON Load Balancing")
plt.savefig("fig4_" + foldername+"_Nlb.png")
...
plt.savefig("fig5_" + foldername+"_Nlb.png")
plt.show()
...
ax2.set_ylabel("tasks completed")
plt.xticks(rotation=360)
plt.savefig("fig6_" + foldername+"_Nlb.png")
...
plt.ylabel('Number of tasks', fontsize=16)
plt.title("Distribution of tasks per node and team NON Load Balancing")
plt.savefig("fig7_" + foldername+"_Nlb.png")
plt.show()
